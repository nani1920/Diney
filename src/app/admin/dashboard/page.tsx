    ...
    <div className="min-h-screen bg-[#050505] text-white p-6 md:p-12 selection:bg-red-500/30">
        ...
        <header className="flex flex-col md:flex-row md:items-end justify-between gap-8 mb-16">
          <div>
            <div className="flex items-center gap-4 mb-4">
              ...
              <div className="flex items-center gap-3">
                ...
                <span className="text-[10px] font-black uppercase tracking-[0.3em] text-[#025E43]">Merchant Registry</span>
              </div>
            </div>
          ...
          <div className="flex items-center gap-4">
            <button
              ...
              className="flex items-center gap-3 px-6 py-4 bg-white/5 border border-white/10 text-white rounded-2xl font-black uppercase tracking-widest text-xs hover:bg-white/10 transition-all active:scale-95"
            >
              <LogOut size={16} />
              Sign Out
            </button>
            <button
              ...
              className="group flex items-center gap-3 px-8 py-4 bg-white text-black rounded-2xl font-black uppercase tracking-widest text-xs hover:bg-neutral-200 transition-all active:scale-95 shadow-xl shadow-white/5"
            >
      ...
      <footer className="max-w-6xl mx-auto mt-20 pt-8 border-t border-white/5 flex justify-between items-center opacity-30 grayscale hover:grayscale-0 hover:opacity-100 transition-all duration-700">
        <div className="flex items-center gap-2">
          ...
          <span className="text-[10px] font-black uppercase tracking-widest">Authorized Merchant Portal</span>
        </div>
...
function StoreCard({ tenant, index, onSelect }: { tenant: any, index: number, onSelect: any }) {
  ...
  return (
    ...
    >
      ...
      <div>
        <h3 className="text-2xl font-black italic uppercase tracking-tight mb-1 group-hover:text-[#025E43] transition-colors">
          {tenant.name}
        </h3>
      ...
      <div className="mt-8 pt-6 border-t border-white/5 flex items-center justify-between">
        <span className="text-[9px] font-black text-neutral-600 uppercase tracking-widest italic group-hover:text-neutral-400">
...
function EmptyState({ onAction }: { onAction: any }) {
  return (
    <div className="py-24 text-center border-2 border-dashed border-white/5 rounded-[3rem] bg-neutral-900/10">
      ...
      <h2 className="text-3xl font-black italic uppercase tracking-tighter mb-4">No Active Records</h2>
      ...
      <button
        onClick={onAction}
        className="px-10 py-5 bg-[#025E43] text-white rounded-2xl font-black uppercase tracking-widest text-xs hover:bg-[#1A1A1A] transition-all active:scale-95 shadow-2xl shadow-[#025E43]/20"
      >
        Launch First Store
      </button>
    </div>
